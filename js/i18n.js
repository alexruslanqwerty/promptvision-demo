const translations = {
  ru: {
    ...
    sidebar_tools: "Инструменты AI",
    sidebar_archives: "История & Архивы",
    nav_gallery: "Галерея промптов",
    refinement_title: "Стили и Параметры (Refinements)",
    btn_randomize: "Случайно",
    engine_compare: "Сравнить оба движка (A/B Test)",
    tpl_detailed: "Подробное описание",
    tpl_caption: "Краткое описание",
    tpl_people: "Описание людей",
    tpl_marketing: "Маркетинговый текст",
    tpl_fashion: "Одежда и мода",
    tpl_objects: "Распознавание объектов",
    tpl_problems: "Решение задач по изображению",
    tpl_art_style: "Анализ художественного стиля",
    tpl_chatgpt: "Создать промпт для ChatGPT",
    tpl_image_prompt: "Создать промпт изображения",
    tpl_nano: "Создать промпт Nano Banana",
    tpl_midjourney: "Создать промпт для Midjourney",
    tpl_flux: "Создать промпт для Flux",
    tpl_pixar: "Создать промпт 3D Pixar",
    tpl_json: "Создать JSON-промпт"
  },
  en: {
    ...
    sidebar_tools: "AI Tools",
    sidebar_archives: "History & Archives",
    nav_gallery: "Prompt Gallery",
    refinement_title: "Styles & Refinements",
    btn_randomize: "Randomize",
    engine_compare: "Compare both engines (A/B Test)",
    tpl_detailed: "Detailed Description",
    tpl_caption: "Short Caption",
    tpl_people: "People Description",
    tpl_marketing: "Marketing Copy",
    tpl_fashion: "Fashion & Clothing",
    tpl_objects: "Object Recognition",
    tpl_problems: "Problem Solving from Image",
    tpl_art_style: "Art Style Analysis",
    tpl_chatgpt: "Generate ChatGPT Prompt",
    tpl_image_prompt: "Generate Image Prompt",
    tpl_nano: "Generate Nano Banana Prompt",
    tpl_midjourney: "Generate Midjourney Prompt",
    tpl_flux: "Generate Flux Prompt",
    tpl_pixar: "Generate 3D Pixar Prompt",
    tpl_json: "Generate JSON Prompt"
  }
};
